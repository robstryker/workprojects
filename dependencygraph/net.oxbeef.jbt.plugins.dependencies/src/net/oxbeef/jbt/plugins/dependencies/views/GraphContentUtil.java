...
public class GraphContentUtil {
	...
	private String ensmallenPluginName(String name) {
	...
	private boolean isRedundant(HashMap<String, ArrayList<String>> map, String source, String dep, boolean ignoreDep) {
